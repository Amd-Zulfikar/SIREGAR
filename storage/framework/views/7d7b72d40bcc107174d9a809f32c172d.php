...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'SiReGar App'); ?></title>
        ...
        <aside class="main-sidebar main-sidebar-custom sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="javascript:void(0)" class="d-block"><?php echo e(Auth::user()->name); ?> |
                            <?php echo e(Auth::user()->role->name); ?></a>
                    </div>
                </div>
               ...
               with font-awesome or any other icon font library -->
                        <li
                            class="nav-item has-treeview <?php echo e(request()->routeIs('admin.dashboard') ? 'menu-open' : ''); ?>">
                        ...
                        <li
                            class="nav-item has-treeview <?php echo e(request()->routeIs('index.transaction') ? 'menu-open' : ''); ?>">
                            <a href="<?php echo e(route('index.transaction')); ?>"
                                class="nav-link <?php echo e(request()->routeIs('index.transaction') ? 'active' : ''); ?>">
                        ...
                        <li
                            class="nav-item has-treeview <?php echo e(request()->routeIs('index.role', 'add.role', 'edit.role', 'index.employee', 'add.employee', 'edit.employee', 'index.customer', 'add.customer', 'edit.customer', 'index.account', 'add.account', 'edit.account', 'index.pemeriksa', 'add.pemeriksa', 'edit.pemeriksa') ? 'menu-open' : ''); ?>">
                            <a href="javascript:void(0)"
                                class="nav-link <?php echo e(request()->routeIs('index.role', 'add.role', 'edit.role', 'index.employee', 'add.employee', 'edit.employee', 'index.customer', 'add.customer', 'edit.customer', 'index.account', 'add.account', 'edit.account', 'index.pemeriksa', 'add.pemeriksa', 'edit.pemeriksa') ? 'active' : ''); ?>">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo e(route('index.role')); ?>"
                                        class="nav-link <?php echo e(request()->routeIs('index.role', 'add.role', 'edit.role') ? 'active' : ''); ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Role</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('index.employee')); ?>"
                                        class="nav-link <?php echo e(request()->routeIs('index.employee', 'add.employee', 'edit.employee') ? 'active' : ''); ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Pegawai</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('index.customer')); ?>"
                                        class="nav-link <?php echo e(request()->routeIs('index.customer', 'add.customer', 'edit.customer') ? 'active' : ''); ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Customer</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('index.pemeriksa')); ?>"
                                        class="nav-link <?php echo e(request()->routeIs('index.pemeriksa', 'add.pemeriksa', 'edit.pemeriksa') ? 'active' : ''); ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Pemeriksa</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('index.account')); ?>"
                                        class="nav-link <?php echo e(request()->routeIs('index.account', 'add.account', 'edit.account') ? 'active' : ''); ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Account</p>
                                    </a>
                                </li>
                        ...
                        <li
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo e(route('index.submission')); ?>"
                                        class="nav-link <?php echo e(request()->routeIs('index.submission', 'add.submission', 'edit.submission') ? 'active' : ''); ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Jenis Pengajuan</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('index.varian')); ?>"
                                        class="nav-link <?php echo e(request()->routeIs('index.varian', 'add.varian', 'edit.varian') ? 'active' : ''); ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Jenis Varian</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('index.engine')); ?>"
                                        class="nav-link <?php echo e(request()->routeIs('index.engine', 'add.engine', 'edit.engine') ? 'active' : ''); ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Engine</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('index.brand')); ?>"
                                        class="nav-link <?php echo e(request()->routeIs('index.brand', 'add.brand', 'edit.brand') ? 'active' : ''); ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Merk</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('index.chassis')); ?>"
                                        class="nav-link <?php echo e(request()->routeIs('index.chassis', 'add.chassis', 'edit.chassis') ? 'active' : ''); ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Chassis</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('index.vehicle')); ?>"
                                        class="nav-link <?php echo e(request()->routeIs('index.vehicle', 'add.vehicle', 'edit.vehicle') ? 'active' : ''); ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Vehicle</p>
                                    </a>
                                </li>
                        ...
                        <li
                            class="nav-item has-treeview <?php echo e(request()->routeIs('index.mgambar', 'add.mgambar', 'edit.mgambar', 'copy.mgambar', 'index.mgambaroptional', 'add.mgambaroptional', 'edit.mgambaroptional', 'index.mgambarelectricity', 'add.mgambarelectricity', 'edit.mgambarelectricity') ? 'menu-open' : ''); ?>">
                            <a href="javascript:void(0)"
                                class="nav-link <?php echo e(request()->routeIs('index.mgambar', 'add.mgambar', 'edit.mgambar', 'copy.mgambar', 'index.mgambaroptional', 'add.mgambaroptional', 'edit.mgambaroptional', 'index.mgambarelectricity', 'add.mgambarelectricity', 'edit.mgambarelectricity') ? 'active' : ''); ?>">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo e(route('index.mgambaroptional')); ?>"
                                        class="nav-link <?php echo e(request()->routeIs('index.mgambaroptional', 'add.mgambaroptional', 'edit.mgambaroptional') ? 'active' : ''); ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Master Optional</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('index.mgambarelectricity')); ?>"
                                        class="nav-link <?php echo e(request()->routeIs('index.mgambarelectricity', 'add.mgambarelectricity', 'edit.mgambarelectricity') ? 'active' : ''); ?>">
                                        <i class="far fa-circle nav-icon"></i>
...
<?php /**PATH D:\02. ZULFIKAR\CODING\REKAYASA\SIREGAR\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>