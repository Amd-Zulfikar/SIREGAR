                    ...
                    <div class="col-md-12">
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body table-responsive">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="checkbox" class="status-switch"
                                                        data-id="<?php echo e($mdata->id); ?>" name="status"
                                                        <?php echo e($mdata->status ? 'checked' : ''); ?> data-bootstrap-switch
                                ...
                                <div class="mt-2">
                                    <?php echo e($mdatas->links('pagination::bootstrap-4')); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('switchChange.bootstrapSwitch', '.status-switch', function(event, state) {
                ...
                $.ajax({
                    url: "<?php echo e(url('admin/mdata/action')); ?>/" + id,
                    method: "POST",
                    data: {
                        status: newStatus,
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\02. ZULFIKAR\CODING\colaborasi\SIREGAR\resources\views\admin\mdata\index.blade.php ENDPATH**/ ?>