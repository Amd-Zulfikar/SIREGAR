    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <a href="<?php echo e(route('index.workspace')); ?>" class="btn bg-gradient-primary">KEMBALI</a>
            </div>
        </section>

        <section class="content">
            <div class="container-fluid">
                <form id="form-edit-workspace" method="POST" action="<?php echo e(route('update.workspace', $workspace->id)); ?>">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('drafter.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\CODING\REKAYASA\SIREGAR\resources\views\drafter\workspace\edit_workspace.blade.php ENDPATH**/ ?>