...
<?php $__env->startSection('content'); ?>
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <form method="POST" action="<?php echo e(route('store.mgambaroptional')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="col-md-12">
                                            ...
                                            <div id="gambar-detail-container">
                                                <div class="form-group border p-3 rounded mb-3"
                                                    ...
                                                    <div class="input-group mb-2">
                                                        ...
                                                        <div class="input-group-append">
                                                            <label class="btn btn-sm btn-info mb-0">
                                                                Upload Gambar
                                                                <input type="file" name="foto_detail[]"
                                                                    class="foto_detail" style="display: none;"
                                                    ...
                                                    <input name="description[]" type="text"
                                                        ...
                                                        placeholder="Contoh: DETAIL PENGIKAT KURSI DLL" required>
                                                </div>
                                            </div>
        ...
        $(function() {
            ...
            $('#add-gambar').on('click', function() {
                ...
                <div class="form-group border p-3 rounded mb-3" style="background-color: #f7f9fc;">
                    <label class="text-info"><i class="fas fa-image"></i> Gambar Detail</label>
                    <div class="input-group mb-2">
                        <input type="text" class="form-control form-control-sm file-name-display" value="Belum ada file dipilih" readonly>
                        <div class="input-group-append">
                            <label class="btn btn-sm btn-info mb-0">
                                Upload Gambar
                                <input type="file" name="foto_detail[]" class="foto_detail" style="display: none;" accept="image/*" onchange="updateFileName(this)">
                            </label>
                        </div>
                    </div>
                    <div class="preview mt-2"></div>
            ...
            `;
                $('#gambar-detail-container').append(newField);
            });
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\02. ZULFIKAR\CODING\REKAYASA\SIREGAR\resources\views/admin/mgambar_optional/add_mgambar_optional.blade.php ENDPATH**/ ?>