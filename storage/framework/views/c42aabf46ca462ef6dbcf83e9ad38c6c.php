                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-12 col-md-2">
                                            <div class="form-group">
                                                ...
                                                <select id="keterangans" class="form-control select2">
                                                    <option value="" disabled selected>Pilih Body</option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-8">
                                            ...
                                            <button type="button" id="btn-tambah-rincian" class="btn btn-primary"><i
                                                    class="fa-solid fa-folder-plus"></i>
                                                Tambah Data
                                            </button>
                                            <button type="button" id="btn-update-rincian" class="btn btn-warning"><i
                            ...
                            <div class="col-12">
                                <div class="card card-outline card-info">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <br>
                                        <button type="button" id="btn-simpan-ws"
                                            class="btn btn-success float-right">Ambil
                                            Gambar</button>
...
<?php echo $__env->make('drafter.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\02. ZULFIKAR\CODING\REKAYASA\SIREGAR\resources\views\drafter\workspace\edit_workspace.blade.php ENDPATH**/ ?>