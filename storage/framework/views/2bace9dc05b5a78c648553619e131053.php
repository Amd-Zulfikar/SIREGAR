        ...
        <aside class="main-sidebar main-sidebar-custom sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li
                            class="nav-item has-treeview <?php echo e(request()->routeIs('index.role', 'index.employee', 'index.customer', 'index.account') ? 'menu-open' : ''); ?>">
                            <a href="javascript:void(0)"
                                class="nav-link <?php echo e(request()->routeIs('index.role', 'index.employee', 'index.customer', 'index.account') ? 'active' : ''); ?>">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo e(route('index.role')); ?>"
                                        class="nav-link <?php echo e(request()->routeIs('index.role') ? 'active' : ''); ?>">
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo e(route('index.employee')); ?>"
                                        class="nav-link <?php echo e(request()->routeIs('index.employee') ? 'active' : ''); ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Pegawai</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('index.customer')); ?>"
                                        class="nav-link <?php echo e(request()->routeIs('index.customer') ? 'active' : ''); ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Customer</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('index.account')); ?>"
                                        class="nav-link <?php echo e(request()->routeIs('index.account') ? 'active' : ''); ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Account</p>
                                    </a>
                                </li>
                        ...
                        <li
                            class="nav-item has-treeview <?php echo e(request()->routeIs('index.submission', 'index.varian', 'index.engine', 'index.brand', 'index.chassis', 'index.vehicle', 'index.mdata') ? 'menu-open' : ''); ?>">
                            <a href="javascript:void(0)"
                                class="nav-link <?php echo e(request()->routeIs('index.submission', 'index.varian', 'index.engine', 'index.brand', 'index.chassis', 'index.vehicle', 'index.mdata') ? 'active' : ''); ?>">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo e(route('index.submission')); ?>"
                                        class="nav-link <?php echo e(request()->routeIs('index.submission') ? 'active' : ''); ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Jenis Pengajuan</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('index.varian')); ?>"
                                        class="nav-link <?php echo e(request()->routeIs('index.varian') ? 'active' : ''); ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Jenis Varian</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('index.engine')); ?>"
                                        class="nav-link <?php echo e(request()->routeIs('index.engine') ? 'active' : ''); ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Engine</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('index.brand')); ?>"
                                        class="nav-link <?php echo e(request()->routeIs('index.brand') ? 'active' : ''); ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Merk</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('index.chassis')); ?>"
                                        class="nav-link <?php echo e(request()->routeIs('index.chassis') ? 'active' : ''); ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Chassis</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('index.vehicle')); ?>"
                                        class="nav-link <?php echo e(request()->routeIs('index.vehicle') ? 'active' : ''); ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Vehicle</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('index.mdata')); ?>"
                                        class="nav-link <?php echo e(request()->routeIs('index.mdata') ? 'active' : ''); ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Master Data</p>
                                    </a>
                                </li>
                        ...
                        <li
                            class="nav-item has-treeview <?php echo e(request()->routeIs('index.mgambar') ? 'menu-open' : ''); ?>">
                            <a href="javascript:void(0)"
                                class="nav-link <?php echo e(request()->routeIs('index.mgambar') ? 'active' : ''); ?>">
...
<?php /**PATH D:\02. ZULFIKAR\CODING\colaborasi\SIREGAR\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>