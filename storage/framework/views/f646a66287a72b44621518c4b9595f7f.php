<?php $__env->startSection('content'); ?>
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <form method="POST" action="<?php echo e(route('update.employee', [$employee->id])); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-outline card-info">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input name="name" type="text"
                                                    value="<?php echo e(old('name', $employee->name)); ?>" class="form-control"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="contact" type="text"
                                                    value="<?php echo e(old('contact', $employee->contact)); ?>" class="form-control"
                                                    placeholder="Masukan contact" required>
                                                <small class="text-danger"><?php echo e($errors->first('contact')); ?></small>
                                            </div>
                                        </div>
                                ...
                                <div class="card-footer">
                                    <a href="<?php echo e(route('index.employee')); ?>" class="btn btn-outline-danger">Kembali</a>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\02. ZULFIKAR\CODING\colaborasi\SIREGAR\resources\views\admin\employee\edit_employee.blade.php ENDPATH**/ ?>