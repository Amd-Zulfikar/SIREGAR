                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-left">
                            <a type="button" class="btn btn-block bg-gradient-primary"
                                onclick="location.href='<?php echo e(route('add.vehicle')); ?>'">Tambah Data</a>
                        </ol>
                    </div>
                    <div class="col-sm-6">
                                            ...
                                            <?php $__empty_1 = true; $__currentLoopData = $vehicles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                ...
                                                <td>
                                                    <input type="checkbox" class="status-switch"
                                                        data-id="<?php echo e($vehicle->id); ?>" name="status"
                                                        <?php echo e($vehicle->status ? 'checked' : ''); ?> data-bootstrap-switch
                                                        data-off-color="danger" data-on-color="success">
                                                </td>
                                                <td>
                                                    <a class="btn btn-info btn-sm"
                                                        href="<?php echo e(route('edit.vehicle', $vehicle->id)); ?>">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('switchChange.bootstrapSwitch', '.status-switch', function(event, state) {
                ...
                $.ajax({
                    url: "<?php echo e(url('admin/vehicle/action')); ?>/" + id,
                    method: "POST",
                    data: {
                        status: newStatus,
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\02. ZULFIKAR\CODING\colaborasi\SIREGAR\resources\views\admin\vehicle\index.blade.php ENDPATH**/ ?>