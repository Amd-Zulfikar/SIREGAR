                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select name="engines"
                                                    class="form-control select2 <?php $__errorArgs = ['engines'];
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="brands"
                                                    class="form-control select2 <?php $__errorArgs = ['brands'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                                            ...
                                            <div class="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <select name="chassiss"
                                                        class="form-control select2 <?php $__errorArgs = ['chassiss'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                        ...
                                                        <?php $__currentLoopData = $chassiss; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chassis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($chassis->id); ?>"><?php echo e($chassis->name); ?>

                                                            </option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                    <?php $__errorArgs = ['chassiss'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="vehicles"
                                                        class="form-control select2 <?php $__errorArgs = ['vehicles'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="card-footer me-2">
                                    <a href="<?php echo e(route('index.mdata')); ?>" class="btn btn-outline-danger mr-2">Kembali</a>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\02. ZULFIKAR\CODING\colaborasi\SIREGAR\resources\views/admin/mdata/add_mdata.blade.php ENDPATH**/ ?>