<?php $__env->startSection('content'); ?>
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <form method="POST" action="<?php echo e(route('update.mdata', [$mdata->id])); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-outline card-info">
                                ...
                                <div class="card-footer me-2">
                                    <a href="<?php echo e(route('index.mdata')); ?>" class="btn btn-danger">Kembali</a>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\02. ZULFIKAR\CODING\colaborasi\SIREGAR\resources\views\admin\mdata\edit_mdata.blade.php ENDPATH**/ ?>