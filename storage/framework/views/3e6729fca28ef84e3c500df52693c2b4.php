                                        ...
                                        <div class="row mb-4">
                                            <div class="col-md-6">
                                                <div class="form-group row mb-1 align-items-center">
                                                    <label class="col-sm-3 col-form-label-sm text-left">Jumlah Gbr Tu
                                                        :</label>
                                                    <div class="col-sm-9">
                                                ...
                                                <div class="form-group row mb-1 align-items-center">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select name="submission_id" id="submissions"
                                                            ...
                                                            data-placeholder="Pilih Pengajuan">
                                                            <option></option>
                                                ...
                                                <div class="form-group row mb-1 align-items-center">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select name="employee_id" id="employees"
                                                            class="form-control form-control-sm select2"
                                                            style="width: 100%;" required data-placeholder="Pilih Drafter">
                                                            <option></option>
                                                            <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($e->id); ?>"><?php echo e($e->name); ?>
                                                    ...
                                                    <?php for($i = 1; $i <= 4; $i++): ?>
                                                        <div id="<?php echo e($type); ?>-row-<?php echo e($i); ?>"
                                                            ...
                                                            <div class="col-md-2 text-right">
                                                                ...
                                                                <button type="button"
                                                                    class="btn btn-info btn-sm preview-gambar-btn"
                                                                    disabled><i class="fa fa-image"></i> Preview
                                                                    Gambar</button>
                                                            </div>
                                                        </div>
                                                    <?php endfor; ?>
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            $(function() {
                ...
                // --- Ambil data keterangan berdasarkan mdata_id ---
                ...
                $(document).on('click', '.preview-gambar-btn', function() {
                    ...
                    let rowId = row.attr('id'); // contoh: "utama-row-1"
                    let jenisGambar = '';

                    if (rowId.startsWith('utama-row')) jenisGambar = 'utama';
                    else if (rowId.startsWith('terurai-row')) jenisGambar = 'terurai';
                    else if (rowId.startsWith('kontruksi-row')) jenisGambar = 'kontruksi';
                    else if (rowId.startsWith('optional-row')) jenisGambar = 'optional';

                    if (!fotoData || !fotoData[jenisGambar]) {
