                                            ...
                                            <?php $__empty_1 = true; $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                ...
                                                <td>
                                                    <input type="checkbox" class="status-switch"
                                                        data-id="<?php echo e($brand->id); ?>" name="status"
                                                        <?php echo e($brand->status ? 'checked' : ''); ?> data-bootstrap-switch
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('switchChange.bootstrapSwitch', '.status-switch', function(event, state) {
                ...
                $.ajax({
                    url: "<?php echo e(url('admin/brand/action')); ?>/" + id,
                    method: "POST",
                    data: {
                        status: newStatus,
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\02. ZULFIKAR\CODING\colaborasi\SIREGAR\resources\views\admin\brand\index.blade.php ENDPATH**/ ?>