...
<?php $__env->startSection('content'); ?>
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <form method="POST" action="<?php echo e(route('update.mgambaroptional', $mgambaroptional->id)); ?>"
                        ...
                        <div class="col-md-12">
                            <div class="card card-outline card-info">
                                <div class="card-header">
                                    <h3 class="card-title">Edit Gambar Optional</h3>
                                </div>
                                                ...
                                                <select name="mdata_id" class="form-control select2" style="width: 100%;"
                                                    ...
                                                    <?php $__currentLoopData = $mdatas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mdata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($mdata->id); ?>"
                                                            <?php echo e($mdata->id == $mgambaroptional->mdata_id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group border p-3 rounded" style="background-color: #f7f9fc;">
                                                ...
                                                <div class="mb-2">
                                                    <?php if($mgambaroptional->file_path && Storage::disk('public')->exists($mgambaroptional->file_path)): ?>
                                                        <img src="<?php echo e(Storage::url($mgambaroptional->file_path)); ?>"
                                                ...
                                                <div class="input-group mb-2">
                                                    ...
                                                    <div class="input-group-append">
                                                        <label class="btn btn-sm btn-info mb-0">
                                                            Upload Gambar
                                                            <input type="file" name="foto_detail" class="foto_detail"
                                                ...
                                                <input type="text" name="description"
                                                    ...
                                                    value="<?php echo e(old('description', $mgambaroptional->description)); ?>"
                                                    required>
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\02. ZULFIKAR\CODING\REKAYASA\SIREGAR\resources\views\admin\mgambar_optional\edit_mgambar_optional.blade.php ENDPATH**/ ?>