<?php $__env->startSection('content'); ?>
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <form method="POST" action="<?php echo e(route('store.employee')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <small><?php echo e($errors->first('contact')); ?></small>
                                            </div>
                                        </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\02. ZULFIKAR\CODING\colaborasi\SIREGAR\resources\views/admin/employee/add_employee.blade.php ENDPATH**/ ?>