        ...
        <aside class="main-sidebar main-sidebar-custom sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        <li
                            class="nav-item has-treeview <?php echo e(request()->routeIs('drafter.dashboard') ? 'menu-open' : ''); ?>">
                            <a href="<?php echo e(route('drafter.dashboard')); ?>"
                                class="nav-link <?php echo e(request()->routeIs('drafter.dashboard') ? 'active' : ''); ?>">
                        ...
                        <li
                            class="nav-item has-treeview <?php echo e(request()->routeIs('index.workspace') ? 'menu-open' : ''); ?>">
                            <a href="javascript:void(0)"
                                class="nav-link <?php echo e(request()->routeIs('index.workspace') ? 'active' : ''); ?>">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo e(route('index.workspace')); ?>"
                                        class="nav-link <?php echo e(request()->routeIs('index.workspace') ? 'active' : ''); ?>">
...
<?php /**PATH D:\02. ZULFIKAR\CODING\colaborasi\SIREGAR\resources\views\drafter\layouts\app.blade.php ENDPATH**/ ?>