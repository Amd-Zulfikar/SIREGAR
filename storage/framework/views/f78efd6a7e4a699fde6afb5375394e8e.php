        ...
        <aside class="main-sidebar main-sidebar-custom sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li
                            class="nav-item has-treeview <?php echo e(request()->routeIs('index.role', 'add.role', 'edit.role', 'index.employee', 'add.employee', 'edit.employee', 'index.customer', 'add.customer', 'edit.customer', 'index.account', 'add.account', 'edit.account') ? 'menu-open' : ''); ?>">
                            <a href="javascript:void(0)"
                                class="nav-link <?php echo e(request()->routeIs('index.role', 'add.role', 'edit.role', 'index.employee', 'add.employee', 'edit.employee', 'index.customer', 'add.customer', 'edit.customer', 'index.account', 'add.account', 'edit.account') ? 'active' : ''); ?>">
