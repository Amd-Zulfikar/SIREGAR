                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-file">
                                                <input type="file" name="foto_paraf[]" id="foto_paraf" class="custom-file-input" multiple required>
        ...
        if (files) {
            Array.from(files).forEach(file => {
                ...
                reader.onload = function(e) {
                    const img = $('<div class="col-4 mb-2"><img src="'+e.target.result+'" class="img-thumbnail" style="width:100%; cursor:pointer;"></div>');
